...
column_list = ['번호', '인제스트 완료시각', '촬영/수신일', '분류', '미디어ID', '제목', '취재기자', '촬영기자', '내용', '영상길이', '메모', '등록위치', '엠바고', '엠바고사유']
...
class metadata_output:
    ...
    def insert_column_division(self):
        try:
            ...
            self.temp_data = self.temp_data[['번호', '구분', '인제스트 완료시각', '촬영/수신일', '분류', '미디어ID', '제목', '취재기자', '촬영기자', '내용', '영상길이', '메모', '등록위치', '엠바고', '엠바고사유']]
        except:
