...
wks = gc.open_by_url('https://docs.google.com/spreadsheets/d/1-Fj44MEAPv7T8qMNvqYSbSi_-elJEn4NsiavlRUhJHM/edit#gid=1554750920')

# '유튜브LIVE 일지' 시트를 선택한다.
worksheet = wks.worksheet('유튜브LIVE 일지')

# '유튜브LIVE 일지' 시트의 Cell 범위를 선택하여 range_list에 저장한다.
range_list = worksheet.range('A234:E258') # 스프레드시트 video_id 영역과 유튜브 데이터 인서트 영역
